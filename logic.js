let QUESTIONS={}, grade=parseInt(localStorage.getItem("grade")||"6"), streak=parseInt(localStorage.getItem("streak")||"0"), usedQuestions={}, currentQuestion=null;

function normalize(str){return str.trim().toLowerCase().replace(/[.\s]+$/,"");}
...
function updateProgressBar(){
  document.getElementById("progressFill").style.width=Math.min(100,streak*10)+"%";
}
